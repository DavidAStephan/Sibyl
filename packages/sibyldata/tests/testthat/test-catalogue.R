...
# ------ Coverage cross-check against martin::equation_catalogue() ------
...
test_that("every adjustable MARTIN equation has an upstream data path", {
  ...
  #     in v0 we splice them from references/MARTIN-master/Data/martin_public.wf1
